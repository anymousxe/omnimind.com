const osCommandSets = {
  'Ubuntu Neural': {
    ...
    commands: ['ls','cd','cat','mkdir','rm','cp','mv','pwd','whoami','uname','neofetch','top','ps','kill','ping','ifconfig','nano','clear','help','play','neuro-scan','dream-status','install-os','reboot']
  },
  'Arch Brain': {
...
function executeCommand(cmd, args, state) {
  ...
  switch (cmdLower) {
    ...
    case 'install-os': { return { installOS: true }; }
