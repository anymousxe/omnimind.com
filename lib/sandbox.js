const osCommandSets = {
  'Ubuntu Neural': {
    ...
    commands: ['ls','cd','cat','mkdir','rm','cp','mv','pwd','whoami','uname','neofetch','top','ps','kill','ping','ifconfig','nano','clear','help','play','neuro-scan','dream-status','install-os','reboot','specs','browser','apps','download','websites']
  },
  'Arch Brain': {
